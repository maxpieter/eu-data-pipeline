    ...
    <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
      ...
      <div className="sidebar-content">
        ...
        <div className="filter-section">
          <div className="filter-label">Find MEP</div>
          <div className="search-container">
            ...
            <input
              ...
              onChange={(e) => onMepSearchChange(e.target.value)}
            />
            {mepSearchQuery && (
              <button
                className="search-clear visible"
                onClick={() => onMepSearchChange('')}
                title="Clear search"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          {mepSearchQuery && (
            <div className="search-info active">
              {mepSearchCount > 0 ? (
                <>
        ...
        {/* Country Search */}
        <div className="filter-section">
          <div className="filter-label">Find Country</div>
          <div className="search-container">
            <svg
              className="search-icon"
              xmlns="http://www.w3.org/2000/svg"
          ...
          {countrySearchQuery && (
            <div className="search-info active">
              {countrySearchInfo || 'No countries found'}
            </div>
          )}
        </div>
